...
import { LogOut, LogIn, Activity, LayoutDashboard, ClipboardList, ShieldAlert } from 'lucide-react';
...
export default function App() {
  ...
  useEffect(() => {
    // Check if there is a saved mock session
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
            <div className="flex gap-1 bg-slate-100 p-1 rounded-lg">
              <TabsList className="bg-transparent h-auto p-0">
                <TabsTrigger 
                  value="dashboard" 
                  className="px-4 py-2 text-xs font-extrabold uppercase tracking-wider data-[state=active]:bg-white data-[state=active]:text-slate-800 data-[state=active]:shadow rounded transition-all"
                >
                ...
                <TabsTrigger 
                  value="coach" 
                  className="px-4 py-2 text-xs font-extrabold uppercase tracking-wider data-[state=active]:bg-slate-900 data-[state=active]:text-emerald-400 data-[state=active]:shadow rounded transition-all flex items-center"
                >
